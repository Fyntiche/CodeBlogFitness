...
namespace CodeBlogFintess.BL
{
    ...
    public class User
    {
        ...
        /// <param name="birthDate"> Дата пождения. </param>
                    ...
                    double height)
        {
            ...
            {
                throw new ArgumentNullException("Имя пользователя не может быть пусты или null.", nameof(name));
            }
